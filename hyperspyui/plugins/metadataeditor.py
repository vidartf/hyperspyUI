...
class MetadataNode:
    ...
    def edit_value(self, value):
        if self.parent and isinstance(self.ref, (int, basestring, bool, float)):
...
class MetadataModel(QAbstractItemModel):
    ...
    def flags(self, index):
        ...
        if index and index.isValid() and index.column() == 1:
            ...
            if not isinstance(node.ref, DictionaryTreeBrowser):
                ...
                elif isinstance(node.ref, (basestring, int, float)):
    ...
    def setData(self, index, value, role=Qt.EditRole):
        ...
        if role == Qt.CheckStateRole:
            ...
            if isinstance(node.ref, (basestring, int, float)):
                try:
